...
public class LightSensorDeviceProxy extends DeviceProxyBase implements LightSensor {
    ...
    public LightSensorDeviceProxy(ZigbeeProxyContext ctx, ZigBeeDevice zbDevice) throws ZigBeeHAException {

        super(ctx, zbDevice);

        illuminanceMeasurement = (IlluminanceMeasurement) getCluster(ProfileConstants.CLUSTER_ID_ILLUMINANCE_MEASUREMENT);
