 ...
 * @since 0.1.0
 */
public interface DeviceProxy extends ZigbeeEndpoint {
    ...
    /**
     * @return return {@link org.bubblecloud.zigbee.network.ZigbeeEndpoint} service that has been refined has {@link DeviceProxy}
     * @since 0.2.0
     */
