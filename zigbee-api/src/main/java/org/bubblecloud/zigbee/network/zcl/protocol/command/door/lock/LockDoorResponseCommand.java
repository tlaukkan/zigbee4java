...
public class LockDoorResponseCommand extends ZclCommand {
    ...
    public LockDoorResponseCommand(final ZclCommandMessage message) {
        super(message);
        this.status = (Byte) message.getFields().get(ZclFieldType.LOCK_DOOR_RESPONSE_COMMAND_STATUS);
    }
    ...
    static {
        ZclUtil.registerCommandTypeClassMapping(ZclCommandType.LOCK_DOOR_RESPONSE_COMMAND,LockDoorResponseCommand.class);
    }
}
