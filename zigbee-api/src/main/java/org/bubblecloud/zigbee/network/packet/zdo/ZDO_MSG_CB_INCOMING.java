...
public class ZDO_MSG_CB_INCOMING extends ZToolPacket /*implements IRESPONSE_CALLBACK,IZDO*/ {
    ...
    private static Map<Integer, Class<? extends ZToolPacket>> clusterToRSP;

	static
	{
		final Map<Integer, Class<? extends ZToolPacket>> buildClusterToRSP = new HashMap<Integer, Class<? extends ZToolPacket>>();

		buildClusterToRSP.put(0x0013, ZDO_END_DEVICE_ANNCE_IND.class);
		buildClusterToRSP.put(0x8000, ZDO_NWK_ADDR_RSP.class);
		buildClusterToRSP.put(0x8001, ZDO_IEEE_ADDR_RSP.class);
		buildClusterToRSP.put(0x8002, ZDO_NODE_DESC_RSP.class);
		buildClusterToRSP.put(0x8004, ZDO_SIMPLE_DESC_RSP.class);
		buildClusterToRSP.put(0x8005, ZDO_ACTIVE_EP_RSP.class);
		buildClusterToRSP.put(0x8006, ZDO_MATCH_DESC_RSP.class);
		buildClusterToRSP.put(0x8020, ZDO_END_DEVICE_BIND_RSP.class);
		buildClusterToRSP.put(0x8021, ZDO_BIND_RSP.class);
		buildClusterToRSP.put(0x8031, ZDO_MGMT_LQI_RSP.class);
		buildClusterToRSP.put(0x8034, ZDO_MGMT_LEAVE_RSP.class);
		buildClusterToRSP.put(0x8036, ZDO_MGMT_PERMIT_JOIN_RSP.class);

		/* These clusters currently have no associated class
		buildClusterToRSP.put(0x8003, ZDO_POWER_DESC_RSP.class)
		buildClusterToRSP.put(0x8010, ZDO_COMPLEX_DESC_RSP.class)
		buildClusterToRSP.put(0x8011, ZDO_USER_DESC.class)
		buildClusterToRSP.put(0x8015, ZDO_SERVER_DISC_RSP.class)
		buildClusterToRSP.put(0x8022, ZDO_UNBIND.class)
		buildClusterToRSP.put(0x8030, ZDO_MGMT_NWK_DISC_RSP.class)
		buildClusterToRSP.put(0x8032, ZDO_MGMT_RTG_RSP.class)
		buildClusterToRSP.put(0x8033, ZDO_MGMT_BIND_RSP.class)
		buildClusterToRSP.put(0x8035, ZDO_MGMT_DIRECT_JOIN_RSP.class)
		*/

		clusterToRSP = Collections.unmodifiableMap(buildClusterToRSP);
	}
