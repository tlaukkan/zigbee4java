...
public enum ZclCommand {
    ...
    ZONE_ENROLL_REQUEST(ZigBeeApiConstants.PROFILE_ID_HOME_AUTOMATION, ZigBeeApiConstants.CLUSTER_ID_IAS_ZONE, IASZone.ZONE_ENROLL_REQUEST_ID);

    final public int profileId;
    final public int clusterId;
    final public int commandId;

    private ZclCommand(int profileId, int clusterId, int commandId){
