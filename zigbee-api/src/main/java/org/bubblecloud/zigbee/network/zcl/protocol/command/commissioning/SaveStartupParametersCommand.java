...
public class SaveStartupParametersCommand extends ZclCommand {
    ...
    public SaveStartupParametersCommand(final ZclCommandMessage message) {
        super(message);
        this.option = (Byte) message.getFields().get(ZclFieldType.SAVE_STARTUP_PARAMETERS_COMMAND_OPTION);
        this.index = (Byte) message.getFields().get(ZclFieldType.SAVE_STARTUP_PARAMETERS_COMMAND_INDEX);
    }
    ...
    static {
        ZclUtil.registerCommandTypeClassMapping(ZclCommandType.SAVE_STARTUP_PARAMETERS_COMMAND,SaveStartupParametersCommand.class);
    }
}
