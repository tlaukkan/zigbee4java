...
public class StoreSceneCommand extends ZclCommand {
    ...
    public StoreSceneCommand(final ZclCommandMessage message) {
        super(message);
        this.groupId = (Short) message.getFields().get(ZclFieldType.STORE_SCENE_COMMAND_GROUP_ID);
        this.sceneId = (Byte) message.getFields().get(ZclFieldType.STORE_SCENE_COMMAND_SCENE_ID);
    }
    ...
    static {
        ZclUtil.registerCommandTypeClassMapping(ZclCommandType.STORE_SCENE_COMMAND,StoreSceneCommand.class);
    }
}
