...
public class RestoreStartupParametersResponseCommand extends ZclCommand {
    ...
    public RestoreStartupParametersResponseCommand(final ZclCommandMessage message) {
        super(message);
        this.status = (Byte) message.getFields().get(ZclFieldType.RESTORE_STARTUP_PARAMETERS_RESPONSE_COMMAND_STATUS);
    }
    ...
    static {
        ZclUtil.registerCommandTypeClassMapping(ZclCommandType.RESTORE_STARTUP_PARAMETERS_RESPONSE_COMMAND,RestoreStartupParametersResponseCommand.class);
    }
}
