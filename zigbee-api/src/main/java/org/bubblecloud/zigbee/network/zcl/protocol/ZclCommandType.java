...
public enum ZclCommandType {
    ...
    READ_ATTRIBUTES_COMMAND(0, ZclClusterType.GENERAL, "Read Attributes Command", true, false),
    READ_ATTRIBUTES_RESPONSE_COMMAND(1, ZclClusterType.GENERAL, "Read Attributes Response Command", true, false),
    WRITE_ATTRIBUTES_COMMAND(2, ZclClusterType.GENERAL, "Write Attributes Command", true, false),
    WRITE_ATTRIBUTES_UNDIVIDED_COMMAND(3, ZclClusterType.GENERAL, "Write Attributes Undivided Command", true, false),
    WRITE_ATTRIBUTES_RESPONSE_COMMAND(4, ZclClusterType.GENERAL, "Write Attributes Response Command", true, false),
    WRITE_ATTRIBUTES_NO_RESPONSE_COMMAND(5, ZclClusterType.GENERAL, "Write Attributes No Response Command", true, false),
    CONFIGURE_REPORTING_COMMAND(6, ZclClusterType.GENERAL, "Configure Reporting Command", true, false),
    CONFIGURE_REPORTING_RESPONSE_COMMAND(7, ZclClusterType.GENERAL, "Configure Reporting Response Command", true, false),
    READ_REPORTING_CONFIGURATION_COMMAND(8, ZclClusterType.GENERAL, "Read Reporting Configuration Command", true, false),
    READ_REPORTING_CONFIGURATION_RESPONSE_COMMAND(9, ZclClusterType.GENERAL, "Read Reporting Configuration Response Command", true, false),
    REPORT_ATTRIBUTES_COMMAND(10, ZclClusterType.GENERAL, "Report Attributes Command", true, false),
    DEFAULT_RESPONSE_COMMAND(11, ZclClusterType.GENERAL, "Default Response Command", true, false),
    DISCOVER_ATTRIBUTES_COMMAND(12, ZclClusterType.GENERAL, "Discover Attributes Command", true, false),
    DISCOVER_ATTRIBUTES_RESPONSE_COMMAND(13, ZclClusterType.GENERAL, "Discover Attributes Response Command", true, false),
    READ_ATTRIBUTES_STRUCTURED_COMMAND(14, ZclClusterType.GENERAL, "Read Attributes Structured Command", true, false),
    WRITE_ATTRIBUTES_STRUCTURED_COMMAND(15, ZclClusterType.GENERAL, "Write Attributes Structured Command", true, false),
    WRITE_ATTRIBUTES_STRUCTURED_RESPONSE_COMMAND(16, ZclClusterType.GENERAL, "Write Attributes Structured Response Command", true, false);
