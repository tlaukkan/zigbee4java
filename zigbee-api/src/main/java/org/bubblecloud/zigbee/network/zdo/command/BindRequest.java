 ...
 * BindRequest.
 */
public class BindRequest extends ZdoCommand implements ZdoRequest {
    /**
     * Destination address;
     */
    ...
    public BindRequest(int destinationAddress, long bindSourceAddress, int bindSourceEndpoint, int bindCluster, int bindDestinationAddressingMode, long bindDestinationAddress, int bindDestinationEndpoint) {
