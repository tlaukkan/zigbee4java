...
public class ZigBeeDeviceImpl implements ZigBeeDevice, AFMessageListner, AFMessageProducer {
     ...
     *
     * @param n the new {@link it.cnr.isti.zigbee.api.ZigBeeNode} for the device
     * @return <code>true</code> if and only if the {@link it.cnr.isti.zigbee.api.ZigBeeNode} has been updated
