 ...
 * @since 0.1.0
 */
public interface ElectricalMeasurement extends ZCLCluster {

    static final short ID = 0x0B04;
    static final String NAME = "ElectricalMeasurement";
    static final String DESCRIPTION = "Attributes for querying devices of their electrical measurements.";
