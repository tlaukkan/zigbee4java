...
public class WriteAttributesStructuredResponse extends ZclCommand {
    ...
    public WriteAttributesStructuredResponse() {
        setType(ZclCommandType.WRITE_ATTRIBUTES_STRUCTURED_RESPONSE);
    }
     ...
     */
    public WriteAttributesStructuredResponse(final ZclCommandMessage message) {
        super(message);
        this.records = (List<WriteAttributeStatusRecord>) message.getFields().get(ZclFieldType.WRITE_ATTRIBUTES_STRUCTURED_RESPONSE_RECORDS);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.WRITE_ATTRIBUTES_STRUCTURED_RESPONSE_RECORDS,records);
        return message;
    }
