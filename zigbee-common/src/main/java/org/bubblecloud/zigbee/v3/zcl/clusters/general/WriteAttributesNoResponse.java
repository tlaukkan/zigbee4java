...
public class WriteAttributesNoResponse extends ZclCommand {
    ...
    public WriteAttributesNoResponse() {
        setType(ZclCommandType.WRITE_ATTRIBUTES_NO_RESPONSE);
    }
     ...
     */
    public WriteAttributesNoResponse(final ZclCommandMessage message) {
        super(message);
        this.records = (List<WriteAttributeRecord>) message.getFields().get(ZclFieldType.WRITE_ATTRIBUTES_NO_RESPONSE_RECORDS);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.WRITE_ATTRIBUTES_NO_RESPONSE_RECORDS,records);
        return message;
    }
