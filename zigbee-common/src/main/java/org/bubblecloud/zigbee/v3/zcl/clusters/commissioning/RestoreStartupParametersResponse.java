...
public class RestoreStartupParametersResponse extends ZclCommand {
    ...
    public RestoreStartupParametersResponse() {
        setType(ZclCommandType.RESTORE_STARTUP_PARAMETERS_RESPONSE);
    }
     ...
     */
    public RestoreStartupParametersResponse(final ZclCommandMessage message) {
        super(message);
    ...
    public ZclCommandMessage toCommandMessage() {
        ...
        message.getFields().put(ZclFieldType.RESTORE_STARTUP_PARAMETERS_RESPONSE_STATUS,status);
        return message;
    }
