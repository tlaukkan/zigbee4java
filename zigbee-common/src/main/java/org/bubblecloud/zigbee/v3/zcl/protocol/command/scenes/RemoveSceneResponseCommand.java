...
/**
 * Code generated Remove Scene Response Command value object class.
 */
public class RemoveSceneResponseCommand extends ZclCommand {
    /**
     ...
     */
    public RemoveSceneResponseCommand() {
        this.setType(ZclCommandType.REMOVE_SCENE_RESPONSE_COMMAND);
    }
    ...
    public ZclCommandMessage toCommandMessage() {
        ...
        message.getFields().put(ZclFieldType.REMOVE_SCENE_RESPONSE_COMMAND_STATUS,status);
        message.getFields().put(ZclFieldType.REMOVE_SCENE_RESPONSE_COMMAND_GROUP_ID,groupId);
        message.getFields().put(ZclFieldType.REMOVE_SCENE_RESPONSE_COMMAND_SCENE_ID,sceneId);
        return message;
    }
