...
public class ReadReportingConfigurationResponse extends ZclCommand {
    ...
    public ReadReportingConfigurationResponse() {
        setType(ZclCommandType.READ_REPORTING_CONFIGURATION_RESPONSE);
    }
     ...
     */
    public ReadReportingConfigurationResponse(final ZclCommandMessage message) {
        super(message);
        this.records = (List<AttributeReportingConfigurationRecord>) message.getFields().get(ZclFieldType.READ_REPORTING_CONFIGURATION_RESPONSE_RECORDS);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.READ_REPORTING_CONFIGURATION_RESPONSE_RECORDS,records);
        return message;
    }
