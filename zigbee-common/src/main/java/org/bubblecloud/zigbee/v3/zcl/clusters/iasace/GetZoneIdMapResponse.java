...
public class GetZoneIdMapResponse extends ZclCommand {
    ...
    public GetZoneIdMapResponse() {
        setType(ZclCommandType.GET_ZONE_ID_MAP_RESPONSE);
    }
     ...
     */
    public GetZoneIdMapResponse(final ZclCommandMessage message) {
        super(message);
        this.zoneIdMapSection0 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_0);
        this.zoneIdMapSection1 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_1);
        this.zoneIdMapSection2 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_2);
        this.zoneIdMapSection3 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_3);
        this.zoneIdMapSection4 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_4);
        this.zoneIdMapSection5 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_5);
        this.zoneIdMapSection6 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_6);
        this.zoneIdMapSection7 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_7);
        this.zoneIdMapSection8 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_8);
        this.zoneIdMapSection9 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_9);
        this.zoneIdMapSection10 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_10);
        this.zoneIdMapSection11 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_11);
        this.zoneIdMapSection12 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_12);
        this.zoneIdMapSection13 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_13);
        this.zoneIdMapSection14 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_14);
        this.zoneIdMapSection15 = (Integer) message.getFields().get(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_15);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_0,zoneIdMapSection0);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_1,zoneIdMapSection1);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_2,zoneIdMapSection2);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_3,zoneIdMapSection3);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_4,zoneIdMapSection4);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_5,zoneIdMapSection5);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_6,zoneIdMapSection6);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_7,zoneIdMapSection7);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_8,zoneIdMapSection8);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_9,zoneIdMapSection9);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_10,zoneIdMapSection10);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_11,zoneIdMapSection11);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_12,zoneIdMapSection12);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_13,zoneIdMapSection13);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_14,zoneIdMapSection14);
        message.getFields().put(ZclFieldType.GET_ZONE_ID_MAP_RESPONSE_ZONE_ID_MAP_SECTION_15,zoneIdMapSection15);
        return message;
    }
