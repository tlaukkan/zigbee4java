...
public class ViewSceneCommand extends ZclCommand {
    ...
    public ViewSceneCommand(final ZclCommandMessage message) {
        super(message);
        this.groupId = (Integer) message.getFields().get(ZclFieldType.VIEW_SCENE_COMMAND_GROUP_ID);
        this.sceneId = (Integer) message.getFields().get(ZclFieldType.VIEW_SCENE_COMMAND_SCENE_ID);
    }
