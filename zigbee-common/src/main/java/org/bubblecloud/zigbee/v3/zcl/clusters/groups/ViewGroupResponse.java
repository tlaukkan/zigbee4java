...
public class ViewGroupResponse extends ZclCommand {
    ...
    public ViewGroupResponse() {
        setType(ZclCommandType.VIEW_GROUP_RESPONSE);
    }
     ...
     */
    public ViewGroupResponse(final ZclCommandMessage message) {
        super(message);
        this.status = (Integer) message.getFields().get(ZclFieldType.VIEW_GROUP_RESPONSE_STATUS);
        this.groupId = (Integer) message.getFields().get(ZclFieldType.VIEW_GROUP_RESPONSE_GROUP_ID);
        this.groupName = (String) message.getFields().get(ZclFieldType.VIEW_GROUP_RESPONSE_GROUP_NAME);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.VIEW_GROUP_RESPONSE_STATUS,status);
        message.getFields().put(ZclFieldType.VIEW_GROUP_RESPONSE_GROUP_ID,groupId);
        message.getFields().put(ZclFieldType.VIEW_GROUP_RESPONSE_GROUP_NAME,groupName);
        return message;
    }
