...
public class RemoveSceneResponse extends ZclCommand {
    ...
    public RemoveSceneResponse() {
        setType(ZclCommandType.REMOVE_SCENE_RESPONSE);
    }
     ...
     */
    public RemoveSceneResponse(final ZclCommandMessage message) {
        super(message);
        this.status = (Integer) message.getFields().get(ZclFieldType.REMOVE_SCENE_RESPONSE_STATUS);
        this.groupId = (Integer) message.getFields().get(ZclFieldType.REMOVE_SCENE_RESPONSE_GROUP_ID);
        this.sceneId = (Integer) message.getFields().get(ZclFieldType.REMOVE_SCENE_RESPONSE_SCENE_ID);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.REMOVE_SCENE_RESPONSE_STATUS,status);
        message.getFields().put(ZclFieldType.REMOVE_SCENE_RESPONSE_GROUP_ID,groupId);
        message.getFields().put(ZclFieldType.REMOVE_SCENE_RESPONSE_SCENE_ID,sceneId);
        return message;
    }
