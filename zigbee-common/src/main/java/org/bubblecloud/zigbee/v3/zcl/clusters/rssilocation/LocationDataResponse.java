...
public class LocationDataResponse extends ZclCommand {
    ...
    public LocationDataResponse() {
        setType(ZclCommandType.LOCATION_DATA_RESPONSE);
    }
     ...
     */
    public LocationDataResponse(final ZclCommandMessage message) {
        super(message);
        this.status = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_STATUS);
        this.locationType = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_LOCATION_TYPE);
        this.coordinate1 = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_COORDINATE_1);
        this.coordinate2 = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_COORDINATE_2);
        this.coordinate3 = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_COORDINATE_3);
        this.power = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_POWER);
        this.pathLossExponent = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_PATH_LOSS_EXPONENT);
        this.locationMethod = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_LOCATION_METHOD);
        this.qualityMeasure = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_QUALITY_MEASURE);
        this.locationAge = (Integer) message.getFields().get(ZclFieldType.LOCATION_DATA_RESPONSE_LOCATION_AGE);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_STATUS,status);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_LOCATION_TYPE,locationType);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_COORDINATE_1,coordinate1);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_COORDINATE_2,coordinate2);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_COORDINATE_3,coordinate3);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_POWER,power);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_PATH_LOSS_EXPONENT,pathLossExponent);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_LOCATION_METHOD,locationMethod);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_QUALITY_MEASURE,qualityMeasure);
        message.getFields().put(ZclFieldType.LOCATION_DATA_RESPONSE_LOCATION_AGE,locationAge);
        return message;
    }
