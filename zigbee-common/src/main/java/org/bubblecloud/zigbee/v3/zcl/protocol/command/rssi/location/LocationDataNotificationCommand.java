...
/**
 * Code generated Location Data Notification Command value object class.
 */
public class LocationDataNotificationCommand extends ZclCommand {
    ...
    public LocationDataNotificationCommand() {
        this.setType(ZclCommandType.LOCATION_DATA_NOTIFICATION_COMMAND);
    }
    ...
    public ZclCommandMessage toCommandMessage() {
        ...
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_LOCATION_TYPE,locationType);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_COORDINATE_1,coordinate1);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_COORDINATE_2,coordinate2);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_COORDINATE_3,coordinate3);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_POWER,power);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_PATH_LOSS_EXPONENT,pathLossExponent);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_LOCATION_METHOD,locationMethod);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_QUALITY_MEASURE,qualityMeasure);
        message.getFields().put(ZclFieldType.LOCATION_DATA_NOTIFICATION_COMMAND_LOCATION_AGE,locationAge);
        return message;
    }
