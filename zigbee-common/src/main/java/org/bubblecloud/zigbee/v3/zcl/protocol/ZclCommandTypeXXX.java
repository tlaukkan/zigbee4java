...
public enum ZclCommandTypeXXX {
    ...
    ADD_GROUP_RESPONSE(0, ZclClusterType.GROUPS, " Add Group Response", false, false),
    VIEW_GROUP_RESPONSE(1, ZclClusterType.GROUPS, " View Group Response", false, false),
    GET_GROUP_MEMBERSHIP_RESPONSE(2, ZclClusterType.GROUPS, " Get Group Membership Response", false, false),
    REMOVE_GROUP_RESPONSE(3, ZclClusterType.GROUPS, " Remove Group Response", false, false),
    ...
    ADD_SCENE_RESPONSE(0, ZclClusterType.SCENES, " Add Scene Response", false, false),
    VIEW_SCENE_RESPONSE(1, ZclClusterType.SCENES, " View Scene Response", false, false),
    REMOVE_SCENE_RESPONSE(2, ZclClusterType.SCENES, " Remove Scene Response", false, false),
    REMOVE_ALL_SCENES_RESPONSE(3, ZclClusterType.SCENES, " Remove All Scenes Response", false, false),
    STORE_SCENE_RESPONSE(4, ZclClusterType.SCENES, " Store Scene Response", false, false),
    GET_SCENE_MEMBERSHIP_RESPONSE(5, ZclClusterType.SCENES, " Get Scene Membership Response", false, false),
    ...
    GET_ALARM_RESPONSE(1, ZclClusterType.ALARMS, " Get Alarm Response", false, false),
    ...
    RSSI_RESPONSE(4, ZclClusterType.RSSI_LOCATION, " RSSI Response", true, false),
    ...
    DEVICE_CONFIGURATION_RESPONSE(0, ZclClusterType.RSSI_LOCATION, " Device Configuration Response", false, false),
    LOCATION_DATA_RESPONSE(1, ZclClusterType.RSSI_LOCATION, " Location Data Response", false, false),
    ...
    LOCK_DOOR_RESPONSE(0, ZclClusterType.DOOR_LOCK, " Lock Door Response", false, false),
    UNLOCK_DOOR_RESPONSE(1, ZclClusterType.DOOR_LOCK, " Unlock Door Response", false, false),
    ...
    ARM_RESPONSE(0, ZclClusterType.IAS_ACE, " Arm Response", false, false),
    GET_ZONE_ID_MAP_RESPONSE(1, ZclClusterType.IAS_ACE, " Get Zone ID Map Response", false, false),
    GET_ZONE_INFORMATION_RESPONSE(2, ZclClusterType.IAS_ACE, " Get Zone Information Response", false, false),
    ...
    READ_ATTRIBUTES_RESPONSE(1, ZclClusterType.GENERAL, " Read Attributes Response", true, true),
    ...
    WRITE_ATTRIBUTES_RESPONSE(4, ZclClusterType.GENERAL, " Write Attributes Response", true, true),
    WRITE_ATTRIBUTES_NO_RESPONSE(5, ZclClusterType.GENERAL, " Write Attributes No Response", true, true),
    CONFIGURE_REPORTING_COMMAND(6, ZclClusterType.GENERAL, "Configure Reporting Command", true, true),
    CONFIGURE_REPORTING_RESPONSE(7, ZclClusterType.GENERAL, " Configure Reporting Response", true, true),
    READ_REPORTING_CONFIGURATION_COMMAND(8, ZclClusterType.GENERAL, "Read Reporting Configuration Command", true, true),
    READ_REPORTING_CONFIGURATION_RESPONSE(9, ZclClusterType.GENERAL, " Read Reporting Configuration Response", true, true),
    REPORT_ATTRIBUTES_COMMAND(10, ZclClusterType.GENERAL, "Report Attributes Command", true, true),
    DEFAULT_RESPONSE(11, ZclClusterType.GENERAL, " Default Response", true, true),
    DISCOVER_ATTRIBUTES_COMMAND(12, ZclClusterType.GENERAL, "Discover Attributes Command", true, true),
    DISCOVER_ATTRIBUTES_RESPONSE(13, ZclClusterType.GENERAL, " Discover Attributes Response", true, true),
    ...
    WRITE_ATTRIBUTES_STRUCTURED_RESPONSE(16, ZclClusterType.GENERAL, " Write Attributes Structured Response", true, true);
    ...
    ZclCommandTypeXXX(final int id, final ZclClusterType clusterType, final String label, final boolean received, final boolean generic) {
        this.id = id;
