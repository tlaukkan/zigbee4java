...
public class RestartDeviceResponseResponse extends ZclCommand {
    ...
    public RestartDeviceResponseResponse() {
        setType(ZclCommandType.RESTART_DEVICE_RESPONSE_RESPONSE);
    }
     ...
     */
    public RestartDeviceResponseResponse(final ZclCommandMessage message) {
        super(message);
    ...
    public ZclCommandMessage toCommandMessage() {
        ...
        message.getFields().put(ZclFieldType.RESTART_DEVICE_RESPONSE_RESPONSE_STATUS,status);
        return message;
    }
