...
public class DeviceConfigurationResponse extends ZclCommand {
    ...
    public DeviceConfigurationResponse() {
        setType(ZclCommandType.DEVICE_CONFIGURATION_RESPONSE);
    }
     ...
     */
    public DeviceConfigurationResponse(final ZclCommandMessage message) {
        super(message);
        ...
        this.numberRssiMeasurements = (Integer) message.getFields().get(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_NUMBER_RSSI_MEASUREMENTS);
        this.reportingPeriod = (Integer) message.getFields().get(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_REPORTING_PERIOD);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_STATUS,status);
        message.getFields().put(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_POWER,power);
        message.getFields().put(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_PATH_LOSS_EXPONENT,pathLossExponent);
        message.getFields().put(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_CALCULATION_PERIOD,calculationPeriod);
        message.getFields().put(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_NUMBER_RSSI_MEASUREMENTS,numberRssiMeasurements);
        message.getFields().put(ZclFieldType.DEVICE_CONFIGURATION_RESPONSE_REPORTING_PERIOD,reportingPeriod);
        return message;
    }
