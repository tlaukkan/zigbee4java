...
public class ReadAttributesResponse extends ZclCommand {
    ...
    public ReadAttributesResponse() {
        setType(ZclCommandType.READ_ATTRIBUTES_RESPONSE);
    }
     ...
     */
    public ReadAttributesResponse(final ZclCommandMessage message) {
        super(message);
        this.records = (List<ReadAttributeStatusRecord>) message.getFields().get(ZclFieldType.READ_ATTRIBUTES_RESPONSE_RECORDS);
    }

    @Override
    public ZclCommandMessage toCommandMessage() {
        final ZclCommandMessage message = super.toCommandMessage();
        message.getFields().put(ZclFieldType.READ_ATTRIBUTES_RESPONSE_RECORDS,records);
        return message;
    }
