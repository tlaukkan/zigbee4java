...
/**
 * Test class of {@link ZDO_UNBIND_REQ}
 * 
 * @author <a href="mailto:stefano.lenzi@isti.cnr.it">Stefano "Kismet" Lenzi</a>
 * @version $LastChangedRevision: 799 $ ($LastChangedDate: 2013-08-06 19:00:05 +0300 (Tue, 06 Aug 2013) $)
 * @since 0.3.0
 */
public class ZDO_UNBIND_REQTest {

	@Test
	public void testZDO_UNBIND_REQShortShortLongByteShortByte() {
		//TODO Create a test
	}

	@Test
	public void testZDO_UNBIND_REQShortShortLongByteLongByte() {
		/*
 		 FE 17 25 22 
		 6F 79 
		...
		*/
		...
		ZDO_UNBIND_REQ original = new ZDO_UNBIND_REQ(
		...
		ZDO_UNBIND_REQ modified = new ZDO_UNBIND_REQ(
		...
		int[] packet = new int[]{
				0xFE, 0x17, 0x25, 0x22, //Header : SP, Length, Cmd1, Cmd2 
