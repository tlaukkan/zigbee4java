...
/**
 * Test class of {@link ZDO_NODE_DESC_REQ}
 * 
 * @author <a href="mailto:stefano.lenzi@isti.cnr.it">Stefano "Kismet" Lenzi</a>
 * @version $LastChangedRevision: 799 $ ($LastChangedDate: 2013-08-06 19:00:05 +0300 (Tue, 06 Aug 2013) $)
 * @since 0.1.0
 */
public class ZDO_NODE_DESC_REQTest {

	@Test
	public void testZDO_NODE_DESC_REQShort() {
		ZDO_NODE_DESC_REQ original = new ZDO_NODE_DESC_REQ(
				new ZToolAddress16(0xF0, 0xFA), new ZToolAddress16(0xF0, 0xFA)
		);
		ZDO_NODE_DESC_REQ modified = new ZDO_NODE_DESC_REQ((short) 0xF0FA);
